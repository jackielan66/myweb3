...
contract lanPool is IPool {
    // using A for B 语法解析 这是 Solidity 的库函数调用语法，意思是："为类型 B 附加库 A 中的所有函数"
    ...
    function mint(
        address recipient, // 流动性接收地址
        uint128 amount, // 要添加的流动性数量
